...
def generate_summaries_few_shot(args, model, code, output_file, cnt=0):
    ...
    for idx, c in tqdm(enumerate(code)):
        ...
        message = model.ask(input=f'Please generate a concise name for the following  programming language method:{c},and the answer form is" The suggested name for the given programming language method could be "your answer""')
